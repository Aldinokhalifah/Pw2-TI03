...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 09 Bulan Mei 2024 pada 10.48
...
--
-- Dumping data untuk tabel `admin_dashboard`
--

INSERT INTO `admin_dashboard` (`user_id`, `username`, `password`, `email`, `created_at`) VALUES
(1, 'admin AL', 'admin123', 'admin@example.com', '2024-04-29 09:53:08');
...
(9, '1006', 'AL', 'Jakarta', '2024-04-02', 'L', 'AL@example.com', 'jln.dulu rt 11 rw 12', 1),
(10, '12345', 'Akmal', 'Cirebon', '1997-10-11', 'L', 'Akmal@example.com', 'jln.kebangsaan utara', 3),
(11, '13231', 'agihal', 'bogor', '2004-02-19', 'L', 'agus@gmail.com', 'bojong rt99 rw 12', 5);
...
(6, '2024-04-02', 64, 170, '120/80', 'Normal', 9, 2),
(7, '2024-04-22', 72, 178, '120/80', 'Normal', 9, 3),
(10, '2024-04-25', 80, 188, '120/80', 'Normal', 9, 4);
...
INSERT INTO `pesan_masuk` (`nama_lengkap`, `email`, `phone`, `pesan`) VALUES
('wwwwwwwwww', 'agus@gmail.com', '121343546', 'adedcadc'),
('zaky fikri', 'zaky@example.com', '10927361', 'semoga lebih baik lagi'),
('ryan', 'Ryan@example.com', '10913617', 'semoga lebih baik');
...
(1, 'aldino', '12345', 'AL@example.com', '2024-04-22 07:59:02'),
(4, 'ajam', 'ajam999', 'ajam@example.com', '2024-05-09 06:11:00');
